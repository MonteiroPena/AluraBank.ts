System.register(["../views/index", "../models/index", "../helpers/decorators/index", "../helpers/index", "../services/index"], function (exports_1, context_1) {
    "use strict";
            ...
            NegociacaoController = class NegociacaoController {
                ...
                adiciona() {
                    ...
                    if (!this._ehDiaUtil(data)) {
                        this._mensagemView.update("Somente negociações emm dias úteis, por favor");
                        return;
                    }
